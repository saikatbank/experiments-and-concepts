#!/bin/bash
# ──────────────────────────────────────────────
# deploy.sh — One-command deploy for Proxy Protocol experiment
...
echo ""
echo "Test with:"
echo '  for i in {1..20}; do echo "Request $i"; curl --no-keepalive http://'"$LB_IP"'; echo -e "\n"; done'
echo "══════════════════════════════════════════"
